		...
		return(
			<div>
				...
				<div className="content">
					<img className="image-left" src={require('../img/services1.jpg')} />
				...
				<div className="content">
					<img className="image-right" src={require('../img/services2.jpg')} />
				...
				<div className="content">
					<img className="image-left" src={require('../img/services3.png')} />
				...
				<div className="content">
					<img className="image-right" src={require('../img/services4.png')} />
				...
				<div className="content">
					<img className="image-left" src={require('../img/services5.jpg')} />
				...
				<div className="content">
					<img className="image-right" src={require('../img/services6.jpg')} />
